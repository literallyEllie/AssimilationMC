...
public class CmdTP extends AssiCommand {
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        if(player != null && targetPlayer != null){
            ...
            sendPMessage(sender, "Teleported "+ ColorChart.VARIABLE + player.getName()+ ColorChart.R + " to "+ ColorChart.VARIABLE + targetPlayer.getName()+ ColorChart.R + ".");
        }
        else if(player != null && targetPlayer == null){

            ((Player) sender).teleport(player);
            sendPMessage(sender, "Teleported to " + ColorChart.VARIABLE +player.getName()+ ColorChart.R + ".");
