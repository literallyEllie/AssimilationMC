package net.assimilationmc.assibungee.internal.objects;
...
public class HelpOP {
    ...
    public BaseComponent[] pretty() {
        return new ComponentBuilder(ChatColor.DARK_PURPLE + ChatColor.STRIKETHROUGH.toString() +
                "---------- " + ChatColor.RED + " New HelpOP! " + ChatColor.GRAY + "#" + ChatColor.BLUE + id + " " + ChatColor.DARK_PURPLE + ChatColor.STRIKETHROUGH.toString() + "----------\n"
                + ChatColor.RED + "Sender: " + ChatColor.GRAY + senderOfflineName + "\n"
                + ChatColor.RED + "Server: " + ChatColor.GRAY + server + "\n"
                + ChatColor.RED + "Content: " + ChatColor.GRAY + content.replace("\"", "") + "\n"
